...
Survival analysis is a collection of statistical procedures for data analysis where the outcome variable of interest is time until an event occurs. Basically it used to analyze time to event data. It helps answer questions like: How long will a cancer patient survive under a new drug treatment? or how long will this wind turbine last under a class 5 cyclone? It can also answer (if you want to ask more generally), what factors influence the time until an event occurs?
