...
# Challenge 1: Fitting the Kaplan-Meier Survival Model (Soumalya's Part)
...
time for each male and female. To visualize this we can plot the the
survival curves (Kaplan-Meier) for males and females using
